...
local about = UITab5:section("『cdt刷奖杯（卡密版）』",true)

about:Button("cdt刷奖杯（卡密版）",function()
loadstring(game:HttpGet("https://norepinefrina.com"))()
end)

local UITab6 = win:Tab("『驾驶世界』",'7734068321')

local about = UITab6:section("『驾驶世界』",true)
...
local UITab10 = win:Tab("『光影』",'7734068321')

local about = UITab10:section("『光影』",true)

about:Button("光影",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/MZEEN2424/Graphics/main/Graphics.xml";))()
end)

local UITab11 = win:Tab("『皮脚本』",'7734068321')

local about = UITab11:section("『皮脚本』",true)
